...
const About = () => {
  ...
  const skills = [
    ...
    "Tailwind CSS", 'Bootstrap', "Express", "Wordpress", "Mysql", "C++","Python"
  ];
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="grid grid-cols-1 gap-4 w-full">
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Bachelor of Computer Science & Engineering<br />Shoolini University, Solan (2020-2024)</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Gurgaon, Haryana<br />Available for remote work</p>
                </motion.div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              >
                <div className="flex space-x-5">
                  <a href="https://github.com/pritithakur" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[var(--primary)] dark:text-gray-400 dark:hover:text-[var(--primary)] transition-colors duration-300">
                  ...
                  <a href="https://linkedin.com/in/priti-thakur-193078201/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[var(--primary)] dark:text-gray-400 dark:hover:text-[var(--primary)] transition-colors duration-300">
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                  </a>
                  <a href="https://x.com/PritiThaku96307" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[var(--primary)] dark:text-gray-400 dark:hover:text-[var(--primary)] transition-colors duration-300">
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
